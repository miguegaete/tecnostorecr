 ...
 ***************************************************************************/
 /*function bodydisabled(flag){
	
	if(flag!='active'){
		$("*").attr("disabled", "disabled");
		$("#cargar-load").html('<div class="alert alert-info alert-dismissible" id="alert-esp" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button><span class="glyphicon glyphicon-repeat" aria-hidden="true"></span> <strong>Buscando Impresora ....</strong></div>');	
	}else{
		$("*").removeAttr("disabled");
		$("#cargar-load").html('<div class="alert alert-success alert-dismissible" id="alert-esp" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button><span class="glyphicon glyphicon-ok" aria-hidden="true"></span> <strong>Impresora Conectada correctamente</strong></div>');
		$("#cargar-load").fadeOut(5000);	
	}
...
function useDefaultPrinter() {
    ...
    if (isLoaded()) {
        ...
        window['qzDoneFinding'] = function() {
            ...
            //'Impresora por defecto ' + 'no existe');
 ...
 *    qz.printPS();
 ***************************************************************************/
function printHTML(response,valor) {
    if (notReady()) { return; }
	var f = new Date();
	...
	var titulo = (valor)?"TICKET VENTA":"COMANDA";
	var sizef = (valor)?2:2;
    ...
    var colA = '<table border=0 cellpadding=1 cellspacing=0 width=100%><tr><td align=center><font size=2 ><b>AMANITAS MUSCARI</b></font></td></tr>';
        colA = colA +'<tr><td align=center><font align=center size=1 ><b>Tel. (43) 254 3994</b></font></td></tr>';
		colA = colA +'<tr>';
		colA = colA +'<td align=center><hr width=100%></td>';
		colA = colA +'</tr>';          
		colA = colA +'<tr><td><font size=2 align=center ><b>'+titulo+'</b></font></td></tr></table>';
		...
		colA = colA +'</tr>';  	
		colA = colA +'<tr>';                     
		colA = colA +'<td align=left ><font size=1 ><strong>Mesa:</strong></font></td>';
		colA = colA +'<td align=left ><font size=1 >'+mesa+'</font></td>';	
		colA = colA +'<td align=left ><font size=1 ><strong>Num. Pedido:</strong></font></td>';
	...
	if(valor){
		...
		colA = colA +'<td><font size=2><strong>$'+format(total)+'</strong></font></td>';	
		colA = colA +'</tr>';
	}

		
		colA = colA +'<tr>';
		colA = colA +'<td colspan=4 align=left ><h5>DESCRIPCI&Oacute;N</h5></td>';
		colA = colA +'</tr>';
		colA = colA +'<tr>';
		colA = colA +'<td align=left colspan=4 ><font size='+sizef+' >'+descripcion+'</font></td>';	
		colA = colA +'</tr>'; 	
		colA = colA +'</table>';
