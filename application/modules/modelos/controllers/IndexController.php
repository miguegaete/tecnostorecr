...
class Modelos_IndexController extends Zend_Controller_Action
{
	...
	protected $nm = "Modelos";
	protected $nm_ruta = "modelos";
	...
	public function editarAction()
	{
		...
		$this->view->modelo = $modelos->obtener($id);
	...
	public function guardarAction(){
		...
		$datos = array(
						'MOD_NOMBRE' => $this->_getParam("nombre"),
						'MOD_ESTADO' => $this->_getParam("estado"),
						'MAR_ID' => $this->_getParam("marca")
					   );
	...
	public function listarAction(){
        ...
        if (count($rs)) {
              foreach ($rs as $aux){    
                ...
                $html.='<tr>';
                $html.='<td colspan="6" align="center">No existen Modelos</td>';
                $html.='</tr>';
          }
